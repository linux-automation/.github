...
Linux-Automation GmbH takes the security of its code seriously.
...
This is the default security policy for all repositories within the
`linux-automation` organization on GitHub.
It does not apply to repositories that have their own security policy.

For forks and mirrors, follow the upstream policy in cases where your finding
also applies to the upstream code.
...
If you think you have found a vulnerability in one of our repositories, please
...
Instead, report security vulnerabilities to the [Linux-Automation GmbH Security
Team](mailto:security@linux-automation.com).
...
to test;
do not target Linux-Automation GmbH infrastructure, use social engineering, or
access data that is not your own.
